...
\rfoot{Derivados de renta variable 2025-I}
...
\fancypagestyle{firstpage}{
  ...
  \chead{
      \begin{tabular}{|ccc|r|}
           \hline
           \multirow{11}{*}{\includegraphics[scale=0.08]{../images/Escudo_de_la_Universidad_Nacional_de_Colombia_(2016).png}} &  &  &  \\
           & {\LARGE Universidad Nacional de Colombia} &  & \textbf{Estudiantes:} \\
           &  &  & Jose Acuña Hernandez \\
           ...
           &  &  & Freddy Hernandez \\
           & {\Large Metodos para distribución estacionaria} &  &  \\
           &  &  &  \\
           \hline
      \end{tabular}\\
  }
